...
export default function AllInsights() {
  ...
  const handleAction = (e: React.MouseEvent, actionType: string | undefined) => {
  ...
  return (
    <main className="flex-1 p-6 overflow-auto" data-testid="all-insights-page">
      ...
      >
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">All AI-Generated Insights</h1>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      {insight.actionable && actionType && (
                        <Button
                          size="sm"
                          onClick={(e) => handleAction(e, actionType)}
                          style={{
