...
T = TypeVar("T", bound="MarketplaceInstallResponseInstall")


@_attrs_define
class MarketplaceInstallResponseInstall:
    """
    Attributes:
        plugin_key (str):
        version (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        marketplace_install_response_install = cls(
            plugin_key=plugin_key,
            version=version,
            status=status,
            permissions=permissions,
        ...
        return marketplace_install_response_install
