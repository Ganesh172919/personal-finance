...
from ...models.submit_agent_output_feedback_body import SubmitAgentOutputFeedbackBody
...
def _get_kwargs(
    id: str,
    *,
    body: SubmitAgentOutputFeedbackBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/agent-outputs/{id}/feedback".format(
            id=id,
        ),
    }
