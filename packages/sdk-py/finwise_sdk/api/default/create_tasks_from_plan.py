...
from ...models.create_tasks_from_plan_body import CreateTasksFromPlanBody
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = LooseSuccessResponse.from_dict(response.json())
