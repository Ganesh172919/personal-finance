...
from ...models.marketplace_install_response import MarketplaceInstallResponse
...
) -> Optional[Union[Any, MarketplaceInstallResponse]]:
    if response.status_code == 201:
        response_201 = MarketplaceInstallResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, MarketplaceInstallResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, MarketplaceInstallResponse]
    """
