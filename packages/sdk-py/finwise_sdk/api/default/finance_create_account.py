...
) -> Optional[Union[Any, CreateAccountResponse]]:
    if response.status_code == 201:
        response_201 = CreateAccountResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateAccountResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, CreateAccountResponse]
    """
